        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info mb-4">
                    ...
                    This coupon has been used <strong>{{ $coupon->usage_count }}</strong> time(s)
                    @if($coupon->usage_limit)
                        out of <strong>{{ $coupon->usage_limit }}</strong> available.
                    @else
                        (no limit set).
                    @endif
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="1" class="form-control @error('per_user_limit') is-invalid @enderror" 
                                   id="per_user_limit" name="per_user_limit" value="{{ old('per_user_limit', $coupon->per_user_limit) }}">
